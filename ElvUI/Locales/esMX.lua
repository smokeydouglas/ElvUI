...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/smokeydouglas/ElvUI"] = "ElvUI está cinco o mas revisiones desactualizado. Puedes descargar la versión más nueva de https://github.com/smokeydouglas/ElvUI"
L["ElvUI is out of date. You can download the newest version from https://github.com/smokeydouglas/ElvUI"] = "ElvUI está desactualizado. Puedes descargar la versión más nueva de https://github.com/smokeydouglas/ElvUI"
...
L["For technical support visit us at https://github.com/smokeydouglas/ElvUI."] = "Para soporte técnico visítanos en https://github.com/smokeydouglas/ElvUI."
L["Frame"] = "Marco"
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Tecla"
L["LOGIN_MSG"] = "Welcome to %sElvUI|r version %s%s|r, type /ec to access the in-game configuration menu. If you are in need of technical support you can visit us at https://github.com/smokeydouglas/ElvUI"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/smokeydouglas/ElvUI."] = "Ya has terminado con el proceso de instalación. Si necesitas ayuda o soporte técnico por favor visítanos en https://github.com/smokeydouglas/ElvUI."
